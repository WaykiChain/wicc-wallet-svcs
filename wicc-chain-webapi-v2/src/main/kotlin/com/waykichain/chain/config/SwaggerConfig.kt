...
open class SwaggerConfig {
    ...
    open fun createRestApi(): Docket {
        return Docket(DocumentationType.SWAGGER_2)
                .host(Environment.SWAGGER_BAAS_HOST)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.waykichain.chain.controller"))
    ...
    private fun apiInfo(): ApiInfo {
        return ApiInfoBuilder()
                .title(Environment.SWAGGER_BAAS_TITLE)
...
//                .contact(Contact("WaykiChain","https://wiccdev.org/","biz@waykichainhk.com"))
                .version(Environment.SWAGGER_BAAS_VERSION)
                .build()
    }
}
