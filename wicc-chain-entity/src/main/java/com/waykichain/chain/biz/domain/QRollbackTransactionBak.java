...
/**
 * QRollbackTransactionBak is a Querydsl query type for RollbackTransactionBak
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QRollbackTransactionBak extends com.querydsl.sql.RelationalPathBase<RollbackTransactionBak> {

    private static final long serialVersionUID = 1824806215;

    public static final QRollbackTransactionBak rollbackTransactionBak = new QRollbackTransactionBak("rollback_transaction_bak");
    ...
    public final com.querydsl.sql.PrimaryKey<RollbackTransactionBak> primary = createPrimaryKey(id);

    public QRollbackTransactionBak(String variable) {
        super(RollbackTransactionBak.class, forVariable(variable), "null", "rollback_transaction_bak");
        addMetadata();
    }

    public QRollbackTransactionBak(String variable, String schema, String table) {
        super(RollbackTransactionBak.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QRollbackTransactionBak(String variable, String schema) {
        super(RollbackTransactionBak.class, forVariable(variable), schema, "rollback_transaction_bak");
        addMetadata();
    }

    public QRollbackTransactionBak(Path<? extends RollbackTransactionBak> path) {
        super(path.getType(), path.getMetadata(), "null", "rollback_transaction_bak");
        addMetadata();
    }

    public QRollbackTransactionBak(PathMetadata metadata) {
        super(RollbackTransactionBak.class, metadata, "null", "rollback_transaction_bak");
        addMetadata();
    }
