...
/**
 * QBcWiccBlock is a Querydsl query type for BcWiccBlock
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QBcWiccBlock extends com.querydsl.sql.RelationalPathBase<BcWiccBlock> {

    private static final long serialVersionUID = -1217541147;

    public static final QBcWiccBlock bcWiccBlock = new QBcWiccBlock("bc_wicc_block");
    ...
    public final com.querydsl.sql.PrimaryKey<BcWiccBlock> primary = createPrimaryKey(id);

    public QBcWiccBlock(String variable) {
        super(BcWiccBlock.class, forVariable(variable), "null", "bc_wicc_block");
        addMetadata();
    }

    public QBcWiccBlock(String variable, String schema, String table) {
        super(BcWiccBlock.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QBcWiccBlock(String variable, String schema) {
        super(BcWiccBlock.class, forVariable(variable), schema, "bc_wicc_block");
        addMetadata();
    }

    public QBcWiccBlock(Path<? extends BcWiccBlock> path) {
        super(path.getType(), path.getMetadata(), "null", "bc_wicc_block");
        addMetadata();
    }

    public QBcWiccBlock(PathMetadata metadata) {
        super(BcWiccBlock.class, metadata, "null", "bc_wicc_block");
        addMetadata();
    }
