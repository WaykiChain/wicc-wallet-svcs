...
public class WusdAdminGameTest {
    ...
    @Test
    public void A_testSendPrizeByGame() throws Exception{
        ...
        transferModel1.setAmount(1000000L);
        ...
        transferModel2.setAmount(1000L);
    ...
    @Test
    public void B_testBatchSendPrize() throws Exception{
    ...
    @Test
    public void D_testUnfreezeToken() throws Exception{
